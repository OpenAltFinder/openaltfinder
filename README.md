...
- [Productivity & Utilities](#productivity--utilities)
  ...
  - [Bookmark & Content Management Tools](#bookmark--content-management-tools)
  - [Note Taking & Knowledge Management Tools](#note-taking--knowledge-management-tools)
...
- [APITable](https://openaltfinder.com/tools/apitable) - API-oriented, open source Airtable alternative with database, dashboard, automation, and a no-code app builder.
- [Baserow](https://openaltfinder.com/tools/baserow) - Baserow is an open source no-code database and Airtable alternative. Create your own database without technical experience. Our user friendly no-code tool gives you the powers of a developer without leaving your browser.

- [Beekeeper Studio](https://openaltfinder.com/tools/beekeeper-studio) - Modern and easy to use SQL client for MySQL, Postgres, SQLite, SQL Server, and more. Linux, MacOS, and Windows. 
...
- [DBeaver](https://openaltfinder.com/tools/dbeaver) - DBeaver is a free, universal database tool and SQL client for developers and analysts. Connect to MySQL, PostgreSQL, SQLite, Oracle, and dozens more with a powerful open-source IDE.
...
- [Teable](https://openaltfinder.com/tools/teable) - Teable is a no-code spreadsheet database on Postgres — a fast, open-source Airtable alternative with views, forms, automations, and developer-friendly APIs for every team.
...
- [PhotoPrism](https://openaltfinder.com/tools/photoprism) - PhotoPrism is an AI-powered self-hosted photo library for browsing, organizing, and sharing your collection. Built in Go, it bakes privacy into the core of every feature you use.
...
- [Seafile](https://openaltfinder.com/tools/seafile) - Seafile is a high-performance open-source file sync and share platform for teams. Fast syncing, end-to-end encryption, and reliable cross-device collaboration across all your devices.
...
- [PikoCI](https://openaltfinder.com/tools/pikoci) - PikoCI is a single-binary CI/CD that grows with you. Use any database, any queue, and run anywhere — pipelines as code with built-in caching, scaling, and clean observability.
...
- [KeePassXC](https://openaltfinder.com/tools/keepassxc) - KeePassXC is a cross-platform, community-driven port of KeePass Password Safe. Store credentials locally in an encrypted database, with no cloud required and full data control.
...
- [Linkwarden](https://openaltfinder.com/tools/linkwarden) - Linkwarden is an open-source, self-hostable bookmark manager for collecting, reading, annotating, and preserving web content.
...
- [Anchor](https://openaltfinder.com/tools/anchor) - Offline-first, self-hostable note-taking app with rich text, tags, attachments, and cross-device sync via Docker.
...
- [Anytype](https://openaltfinder.com/tools/anytype) - Local-first, end-to-end encrypted alternative to Notion that lets you build a private knowledge base, docs, and tasks with no central server.
...
- [KillerPDF](https://openaltfinder.com/tools/killerpdf) - KillerPDF is a lightweight, fully portable PDF editor for Windows. Edit, merge, annotate, and sign PDFs locally with no subscription, accounts, or hidden telemetry anywhere on your computer.
...
- [Floppy](https://openaltfinder.com/tools/floppy) - Self-hosted all-in-one media tracker and Trakt alternative for movies, TV, anime, books, games, music, and podcasts.
...
- [Yamtrack](https://openaltfinder.com/tools/yamtrack) - Yamtrack is a self-hosted media tracker for movies, TV shows, anime, games, books, and manga. Sync progress, discover new titles, and manage your watch and read lists from one place.
...
- [WeKan](https://openaltfinder.com/tools/wekan) - WeKan is an open-source kanban board built with Meteor — a free, self-hosted Trello alternative for tracking tasks, lists, cards, and shared team workflows with full control.
...
- [LibreDesk](https://openaltfinder.com/tools/libredesk) - Open-source, self-hosted customer support desk in a single binary. Omnichannel inbox with email and live chat, plus a built-in help center.
...
- [osTicket](https://openaltfinder.com/tools/osticket) - Open-source help desk ticketing system. Routes emails, web forms, and phone requests into a unified agent workspace. Self-hosted, PHP, GPL-2.0.
...
- [Relaticle](https://openaltfinder.com/tools/relaticle) - Open-source CRM with native AI agent support, 30 MCP tools, REST API, and self-hosting capabilities.
- [SuiteCRM](https://openaltfinder.com/tools/suitecrm) - A fully featured open-source enterprise CRM built as a community fork of SugarCRM.
- [Twenty](https://openaltfinder.com/tools/twenty) - A modern, open-source CRM built as a community-driven alternative to Salesforce.
...
- [Templatical](https://openaltfinder.com/tools/templatical) - Open-source drag-and-drop email editor with JSON templates, MJML rendering, and framework-agnostic embedding.
